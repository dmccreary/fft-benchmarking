...
| 2 | Chapters | 3 | Required | Chapter directories with index.md |
| 3 | MicroSims | 2 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 3 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 3 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 2 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 4,119 | Required | Words across student-facing markdown |
...
| Total Words | 4,119 | 230 | Words in markdown files |
| Links | 37 | 0 | Hyperlinks in markdown format |
| Equivalent Pages | 17 | 1 | Estimated pages (250 words/page + visuals) |
