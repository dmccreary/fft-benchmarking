...
|---|---------|-------|--------|-------|
| 1 | Concepts | 574 | Required | Concepts from learning graph |
| 2 | Chapters | 27 | Required | Chapter directories with index.md |
| 3 | MicroSims | 61 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 27 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 27 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 550 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 91 | Recommended | Questions in faq.md |
| 9 | Words | 234,394 | Required | Words across student-facing markdown |
...
| 13 | Labs | 35 | Optional | Hands-on lab pages in docs/labs/ |
...
|-------------|-------------|---------------|-------|
| Diagrams | 59 | 59 | H4 headers starting with '#### Diagram:' |
| Equations | 147 | 0 | LaTeX expressions (inline and display) |
| Total Words | 234,394 | 91,646 | Words in markdown files |
| Links | 1017 | 177 | Hyperlinks in markdown format |
| Equivalent Pages | 982 | 411 | Estimated pages (250 words/page + visuals) |
